...
app.controller('kanLeitosController', ["$scope", "$http", "$filter", "pacienteFactory", "diagnosticosFactory", "alasFactory", function ($scope, $http, $filter, pacienteFactory, diagnosticosFactory, alasFactory) {
